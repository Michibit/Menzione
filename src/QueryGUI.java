...
public class QueryGUI extends JFrame {
	 ...
	 * Create the frame.
	 */
	public QueryGUI(SQLDatabaseConnection d) {
		...
		lblNewLabel_2 = new JLabel("(UPDATE,INSERT,DELETE)");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					if(d.getStatment().executeUpdate(textArea.getText()) == 1) {
					...
					lblNewLabel_1.setText("Query non eseguita!");
					e1.printStackTrace();
				}
